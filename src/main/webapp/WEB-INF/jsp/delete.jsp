   	...
   	<div class="row narrow section-intro with-bottom-sep animate-this">
   		<div class="col-full">
   				...
   				<h3>Services</h3>
                                <h4>  </h4>
                                <h5>   
 <c:forEach items="${listemployeees}" var="employeees">
	      	<div class="bgrid service-item animate-this">	

	      		<span class="icon"><i class="${employeees.icon}"></i></span>            

	            <div class="service-content">
	            	<h3 class="h05">${employeees.heading}</h3>

		            <p>${employeees.description}
	         		</p>	
                    <a href="edit?id=${employeees.id}">Edit</a>
                             <a href="delete?id=${employeees.id}" >Delete</a></td>
