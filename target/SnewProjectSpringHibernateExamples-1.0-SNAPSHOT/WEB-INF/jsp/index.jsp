   	...
   	<div class="row portfolio-content">
   		<div class="col-twelve">
   			<div id="folio-wrap" class="bricks-wrapper">					
	               ...
	               <div class="item-wrap animate-this" data-src="${pageContext.request.contextPath}/resources/images/portfolio/gallery/g-shutterbug.jpg" data-sub-html="#01" > 	
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/shutterbug.jpg" alt="Skaterboy">	                     
	                     <div class="item-text">
	        		...
	        		<div class="brick folio-item">
	               <div class="item-wrap animate-this" data-src="${pageContext.request.contextPath}/resources/images/portfolio/gallery/g-yellowwall.jpg" data-sub-html="#02"> 	
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/yellowwall.jpg" alt="Shutterbug">	                     
	                     <div class="item-text">
	                     	<span class="folio-types">
		     					      Marketing
		     					   </span>
	               ...
	               <div id="02" class='hide'>
	        		...
	        		<div class="brick folio-item">
	               <div class="item-wrap animate-this" data-src="${pageContext.request.contextPath}/resources/images/portfolio/gallery/g-archite="/cture.jpg" data-sub-html="#03" >   	
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/architecture.jpg" alt="Explore">	                     
	                     <div class="item-text">	                     		     					    
		     					   <span class="folio-types">
		     					      Web Design
		     					   </span>
	               ...
	               <div id="03" class='hide'>
					...
					<div class="brick folio-item">
	               <div class="item-wrap animate-this"  data-src="${pageContext.request.contextPath}/resources/images/portfolio/gallery/g-minimalismo.jpg"  data-sub-html="#04" >
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/minimalismo.jpg" alt="Minimalismo">	                     
	                     <div class="item-text">	     					    
		     					   <span class="folio-types">
		     					      Web Design
		     					   </span>
	               ...
	               <div id="04" class='hide'>
					...
					<div class="brick folio-item">
	               <div class="item-wrap animate-this"  data-src="${pageContext.request.contextPath}/resources/portfolio/gallery/g-skaterboy.jpg"  data-sub-html="#05" >  	
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/skaterboy.jpg" alt="Bicycle">	                     
	                     <div class="item-text">	     					    
		     					   <span class="folio-types">
		     					      Branding
		     					   </span>
	               ...
	               <div id="05" class='hide'>
					...
					<div class="brick folio-item">
	               <div class="item-wrap animate-this"  data-src="${pageContext.request.contextPath}/resources/images/portfolio/gallery/g-salad.jpg"  data-sub-html="#06">     	
	                  <a href="#" class="overlay">
	                  	<img src="${pageContext.request.contextPath}/resources/images/portfolio/salad.jpg" alt="Salad">	                     
	                     <div class="item-text">	     					    
		     					   <span class="folio-types">
		     					      Branding
		     					   </span>
            ...
            <ul class="slides">
               ...
               <li>
                  ...
                  <div class="testimonial-author">
                    	<img src="${pageContext.request.contextPath}/resources/images/avatars/user-02.jpg" alt="Author image">
               ...
               <li>
                  ...
                  nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris.    
               	...
               	<div class="testimonial-author">
                    	<img src="${pageContext.request.contextPath}/resources/images/avatars/user-03.jpg" alt="Author image">
                    	<div class="author-info">
                    		John Doe
		...
		<div class="row animate-this">
			<div class="col-twelve">
				...
				<div class="client-lists owl-carousel">
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/mozilla.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/bower.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/codepen.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/envato.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/firefox.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/grunt.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/evernote.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/github.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/joomla.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/jQuery.png" alt=""></div>
  					<div><img src="${pageContext.request.contextPath}/resources/images/clients/wordpress.png" alt=""></div>
				</div>
...
<!--    nachalne form        <form  action="${pageContext.request.contextPath}/add" method="post" modelAttribute="userFormData">     			
                
                   <div class="form-field">
 					   <a href="/SnewProjectSpringHibernateExamples/add">Add Person</a>
               </div>
               <div class="form-field">
               ...
               <div class="row">
                 	<div class="col-six tab-full">
                 		<div class="form-field">
                 			<input name="email" type="text" id="contactEmail" placeholder="Email" value="" >
                 		</div>		      			   
		            </div>
	            	<div class="col-six tab-full">	            
	            		<div class="form-field">
               ...
               <div class="form-field">
                  <input type="submit" value="Submite"></button>
...
<!--                         < yesari ni garna milxaform  action="${pageContext.request.contextPath}/add"  method="post" modelAttribute="userFormData">-->
   ...
   <!-- Java Script
   ================================================== --> 
   <link href="/resorces/css/fonts.css" rel="stylesheet" type="text/css"/>
